...
export const THEME_COMPONENTS: Record<ThemeKey, ComponentType<ThemeProps>> = {
  ...
  swiss: dynamic(() => import("./theme-swiss").then((m) => m.ThemeSwiss)),
  journal: dynamic(() => import("./theme-journal").then((m) => m.ThemeJournal)),
  carte: dynamic(() => import("./theme-carte").then((m) => m.ThemeCarte)),
  serene: dynamic(() => import("./theme-serene").then((m) => m.ThemeSerene)),
  block: dynamic(() => import("./theme-block").then((m) => m.ThemeBlock)),
